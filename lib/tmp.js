...
// TODO:
// warn on garbage-collected directory
// catch SIGINT
...
function _prepareRemoveCallback(removeFunction, arg) {
  ...
  var _cleanupCallback = function _cleanupCallback() {
    if (called) return;
...
function _garbageCollector() {
  console.error('collecting garbage')
  ...
  for (var i = 0, length = _removeObjects.length; i < length; i++) {
    try {
      console.error('removing', _removeObjects[i].arg)
